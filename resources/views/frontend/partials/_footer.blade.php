...
<footer class="footer">
            ...
            <div class="col-12 col-sm-4 col-lg-3">
                <div class="footer-about">
                    <a href="{{ url('/') }}" class="footer-logo"><img
                            src="{{ asset('/public/images/' . setting('site_logo')) }}" alt="logo"></a>
                    <p> {{ __('Follow Us on ') }} </p>
                    <nav>
                        @if (setting('facebook'))
                            <a href="{{ url(setting('facebook')) }}" class="fa-brands fa-facebook-square" style="color: blue;" target="_blank"></a>
                        @endif
                        @if (setting('instagram'))
                            <a href="{{ url(setting('instagram')) }}" class="fa-brands fa-instagram"style=""target="_blank"></a>
                        @endif
                        @if (setting('twitter'))
                            <a href="{{ url(setting('twitter')) }}" class="fa-brands fa-twitter"style="color: #69d2e7;target="_blank""target="_blank"></a>
                        @endif
                        @if (setting('youtube'))
                            <a href="{{ url(setting('youtube')) }}" class="fa-brands fa-youtube"style="color: red;"target="_blank"></a>
                        @endif
                    </nav>
                </div>
            </div>
    ...
    <div class="footer-bottom" style="display: flex;flex-direction: column;flex-wrap: wrap;">
        <p>{{ setting('site_footer') }}</p>
        <p>Developed & Maintained By <a href="https://playon24.com.bd/" target="_blank" style="color: var(--primary);">PlayOn24</a></p>
    </div>
</footer>
<!--======= FOOTER PART END =========-->
