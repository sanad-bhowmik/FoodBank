            ...
            <div class="header-content">
                ...
                <a href="{{ route('home') }}" class="header-logo">
                    <img src="@if (\Route::current()->getName() === ' home') {{ asset('images/' . setting('site_logo')) }}
                        ...
                        data-sticky-logo="{{ asset('images/' . setting('site_logo')) }}" alt="logo" style="height: 92%;">
                </a>
                @php
