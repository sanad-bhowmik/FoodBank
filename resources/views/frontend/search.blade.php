            ...
            <div class="filter-group" id="filter">
                <div class="swiper filter-swiper">
                    <nav class="swiper-wrapper">
                        <a href="#" onclick="expedition('all')" class="expedition" data-filter=".delivery-filter">
                            <button type="button" class="swiper-slide  @if (Request::get('expedition') == 'all') active @endif">
                                <i class="fa-solid fa-check-double"></i>
                                <span>{{ __('frontend.all') }} </span>
                            </button>
                        </a>
                        <a href="#" onclick="expedition('delivery')" class="expedition "
                            data-filter=".delivery-filter">
                        ...
                        <!--<a href="#" onclick="expedition('pickup')" class="expedition" data-filter=".delivery-filter">-->
                        <!--    <button type="button" class="swiper-slide  @if (Request::get('expedition') == 'pickup') active @endif">-->
                        <!--        <i class="fa-solid fa-burger"></i>-->
                        <!--        <span>{{ __('frontend.takeaway') }} </span>-->
                        <!--    </button>-->
                        <!--</a>-->
                        <!--<a href="#" onclick="expedition('table')" class="expedition" data-filter=".delivery-filter">-->
                        ...
                        <div class="filter-select">
                            ...
                            <ul class=" cDrop">
                                <div class="row radiousTxt">
                                    ...
                                    <div class="kilo">
                                    <output id="relationship-status-output" class="relationship">0</output>
                                    <span>{{ __('frontend.km') }} </span>
                                </div>
                                    <input type="range" id="relationship-status-slider" class="relationship-status-slider"
                                       min="1" max="100" step="1" name="distance" value="1">
                                </div>
