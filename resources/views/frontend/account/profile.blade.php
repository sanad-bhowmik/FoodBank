                ...
                <div class="col-12 col-lg-8 col-xl-9">
                    <div class="profile-user">
                        <div class="profile-meta">
                            ...
                            <dl>
                                <dt style="margin-top: 20px;"> {{ $user->name }} </dt>
                                <!--<dd>-->
                        ...
                        <ul class="profile-data">
                            ...
                            <li><span>{{ __('levels.phone') }}</span>{{ $user->phone }}</li>
                    ...
                    <fieldset class="form-fieldset">
                        ...
                        <form class="row" action="{{ route('account.profile.update', $user) }}" method="POST"
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input title="You can't email" id="email" type="text" name="email"
                            ...
                            <div class="col-12 col-md-6 form-group">
                                <label for="number" class="form-label required">{{ __('levels.phone') }} </label>
                                    <input title="You can't number"  class="form-control mobilenumber @error('phone') is-invalid @enderror phone" type="tel"
                                    id="" name="phone" placeholder="" value="{{ old('phone', $user->phone) }}" onkeypress='validate(event)' readonly>
