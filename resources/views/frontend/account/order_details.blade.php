    ...
    <section class="settings">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-8 col-xl-9"  id="invoice-print">
                        ...
                        <ul class="order-track">
                            ...
                            @else
                                <li
                                    ...
                                    <span class="line"></span>
                                    <i class="fa-solid fa-circle-check"style="background-color: #ffc501;"></i>
                            ...
                            @else
                                <li class="{{ $order->status >= \App\Enums\OrderStatus::ACCEPT ? 'tracked active' : '' }}">
                                    <span class="line"></span>
                                    <i class="fa-solid fa-circle-check"style="background-color: #6499E9;"></i>
                            ...
                            <li class=" {{ $order->status >= \App\Enums\OrderStatus::PROCESS ? 'tracked active' : '' }}">
                                <span class="line"></span>
                                <i class="fa-solid fa-circle-check"style="background-color: #FF0075;"></i>
                            ...
                            <li
                                ...
                                <span class="line"></span>
                                <i class="fa-solid fa-circle-check"style="background-color: #742DD2;"></i>
                                <span class="title">{{ __('frontend.on_the_way') }} </span>
                            </li>
                            <li class="{{ $order->status == \App\Enums\OrderStatus::COMPLETED ? 'tracked active' : '' }}">
                                <span class="line"></span>
                                <i class="fa-solid fa-circle-check"style="background-color: green;"></i>
                        ...
                        <div class="order-group">
                            ...
                            <div class="order-box status">
                                ...
                                <ul class="order-box-list">
                                    ...
                                    <li class="order-box-item"><b>{{ __('frontend.payment_status') }} :</b><span
                                            class="badge-text red">{{ trans('payment_status.' . $order->payment_status) ?? null }}</span>
                                    </li>
                        ...
                        <ul class="order-price-list">
                            @if ($order->discount->amount > 0 && Schema::hasColumn('coupons', 'slug'))
                                <li>
                                    ...
                                    <span>{{ currencyFormat($order->discount->amount) }}</span>
                                </li>
                            @endif

                            <li><span>{{ __('frontend.subtotal') }}
                                </span><span>{{ currencyFormat($order->sub_total) }}</span></li>

                            <li><span>{{ __('frontend.delivery_charge') }}
                                </span><span>{{ currencyFormat($order->delivery_charge) }}</span></li>
                            <li>
