                        ...
                        <div class="rest-profile">
                            ...
                            <div class="rest-btns">
                                ...
                                <button type="button" class="rest-book-btn" data-bs-toggle="modal"
                                    ...
                                    <i class="fa-solid fa-qrcode" style="color: #fff;"></i><span>Details</span>
                                    <!-- <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div class="swiper rest-swiper">
                                    ...
                                    <nav class="swiper-wrapper">
                                        @foreach ($categories as $category)
                                            <a href="#listing_product{{ $category->id }}" class="swiper-slide">
                                                {{ $category->name }}
                                            </a>
                                        @endforeach
    ...
    <div class="modal fade booking-modal" id="booking-modal" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('restaurant.reservation') }}" method="GET">
                    ...
                    <div class="booking-modal-footer">
                        <button type="submit" class="cart-btn" >{{ __('frontend.request_to_book') }} </button>
                    </div>
                </form>
                            ...
                            <form action="{{ route('restaurant.ratings-update') }}" method="POST"
                                ...
                                <div id="add-review" class="add-review-box custom-width">
                                    ...
                                    <div class="form-group mt-2 pt-2">
                                        <label class="reviewLabel">{{ __('frontend.write_review') }} <span class="text-danger">*</span> </label>
                                        <textarea name="review" type="text" cols="40" rows="3" aria-label="With textarea" placeholder="{{ __('frontend.write_review') }} " class="form-control @error('review') is-invalid @enderror">{{ old('review') }}</textarea>
