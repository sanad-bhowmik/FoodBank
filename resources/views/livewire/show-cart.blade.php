...
<div>
    ...
    @if (!blank($menuItem))
        <div wire:ignore.self class="modal fade product-modal" id="cartModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form wire:submit="submit({{ $restaurant->id }},{{ $menuItem->id }})">
                            ...
                            <div class="product-modal-group">
                                ...
                                <ul class="product-modal-list">
                                    @foreach ($menuItem->variations as $variation)
                                        <li>
                                            <input wire:model.live="variationID" id="{{ $variation->name }}"
                                                name="variationID" type="radio"
                        ...
                        <div class="product-modal-footer">
                            <div class="cart-counter">
                                ...
                                <input type="number" step=".01" name="product_quantity" id="quantity"
                                    wire:model.live="quantity" value="{{ $quantity }}" min="1" max="99"
                            ...
                            <button class="cart-btn" data-bs-dismiss="modal"onclick="reloadPageAfterDelay()">
...
<script>
    function reloadPageAfterDelay() {
        // Delay the page reload by 5 seconds (5000 milliseconds)
        setTimeout(function() {
            location.reload();
        }, 800);
    }
