<div>
        ...
        <div class="cart-scroll-group">
            ...
            <ul class="cart-list">
                ...
                @foreach ($carts['items'] as $key => $content)
                    <li class="cart-item">
                        <button class="cart-delete"onclick="reloadPageAfterDelay()" wire:click.prevent="removeItem('{{ $key }}')"
                            type="button">
                        ...
                        <div class="cart-meta-group">
                            ...
                            @if (!blank($content['options']))
                                @foreach ($content['options'] as $option)
                                    <h6 class="cart-extra pt-2">+ {{ $option['name'] }}</h6>
                                @endforeach
                            @endif
                        </div>
    ...
    @else
        ...
        <div class="cart-empty">
            <h2 class="cart-title">{{ __('frontend.mycart') }} </h2>
