                ...
                <div class="product-category" id="popular-items">
                    ...
                    <div class="product-card-groupp">
                        ...
                        @if (!blank($categories_product))
                            ...
                            <div class="col-md-6 ">
                                <div class="product-card" style="box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
                                    ...
                                    <div class="product-card-content">
                                        ...
                                        <p class="product-card-text">
                                            {!! \Illuminate\Support\Str::limit(strip_tags($menu_item['description']), 100) !!}
                                        </p>
                                        ...
                                        <div class="product-card-info">
                                            <div class="product-card-price">
                                                @if ($menu_item['discount_price'] > 0)
                                                    ...
                                                    <span> {{ setting('currency_code') }}{{ $menu_item['unit_price'] - $menu_item['discount_price'] }}
                                                    </span>
                                                @else
                                                    <span>
                                            ...
                                            @else
                                                <a href="#variation-{{ $menu_item['id'] }}" class="product-card-add"
                                                    wire:click.prevent="addToCartModal({{ $menu_item['id'] }})">
                                                    <svg width="14" height="14" viewBox="0 0 14 14"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
    ...
    @if (!blank($other_products))
        <div wire:ignore="" id="listing_product_other">
            <div class="product-category" id="popular-items">
                ...
                <div class="product-card-groupp">
                    <div class="row gx-3 gy-3">
                        @foreach ($other_products as $menu_item)
                        <div class="col-md-6 ">
