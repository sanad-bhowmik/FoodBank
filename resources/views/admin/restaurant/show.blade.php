                    ...
                    <div class="card">
                        <div class="card-body card-profile restaurant-edit-button">
                            ...
                            @isset(auth()->user()->restaurant->id)
                                <a href="{{ route('admin.restaurant.restaurant-edit', auth()->user()->restaurant->id) }}" class="btn btn-sm btn-icon btn-primary restaurant-edit-icon" data-toggle="tooltip" data-placement="top" data-original-title="Edit"> <i class="far fa-edit"></i></a>
                            @endisset
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="maintable" data-restaurantid="{{ $restaurant->id }}" data-url="{{ route('admin.restaurant.get-menu-items') }}" data-hidecolumn="{{ auth()->user()->can('restaurant_edit') || auth()->user()->can('restaurant_delete') }}">
                                    <thead>
                                    <tr>
                                        <th>{{ __('levels.id') }}</th>
