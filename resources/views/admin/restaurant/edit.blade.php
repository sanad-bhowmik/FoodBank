                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <input id="first_name" type="text" name="first_name" class="form-control form-control-sm @error('first_name') is-invalid @enderror" value="{{ old('first_name', $restaurant->user->first_name) }}" readonly>
                                        @error('first_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input id="last_name" type="text" name="last_name" class="form-control form-control-sm @error('last_name') is-invalid @enderror" value="{{ old('last_name', $restaurant->user->last_name) }}" readonly>
                                        @error('last_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <input id="email" type="text" name="email" class="form-control form-control-sm @error('email') is-invalid @enderror" value="{{ old('email', $restaurant->user->email) }}" readonly>
                                        @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input id="username" type="text" name="username" class="form-control form-control-sm @error('username') is-invalid @enderror" value="{{ old('username', $restaurant->user->username) }}"readonly>
                                        @error('username')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input id="phone" type="text" name="phone" class="form-control form-control-sm @error('phone') is-invalid @enderror" value="{{ old('phone', $restaurant->user->phone) }}"readonly>
                                        @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
