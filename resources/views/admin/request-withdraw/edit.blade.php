						    ...
						    <div class="card-body">
								...
								<div class="form-row">
									...
									<div class="form-group col">
                                        ...
                                        <?php  $selectUser = $user; ?>
                                        @endif
										<option {{ $user->id == $requestwithdraw->user_id ? 'selected':''}} value={{ $user->id }}>{{ $user->name  }} ( {{ trans('user_roles.'.$user->myrole) }} )</option>
                                        @endforeach
                                        @endif
                                    </select>
										@error('user_id')
								...
								<input type="hidden" name="user_id" id="user_id" value="{{ auth()->user()->id }}" data-url="{{ route('admin.request-withdraw.get-user-info') }}">
