...
Route::group(['prefix' => 'v1'], function () {
   ...
   Route::post('category', [CategoryController::class, 'store'])->middleware('api');

// new
    Route::get('category/{id}/shows',                            [CategoryController::class, 'shows']); //done
    // new
    ...
    Route::post('restaurant-menuItem/menuItem', [MenuItemController::class, 'store2']);
    ...
    Route::get('notification-orders',                            [NotificationOrderController::class, 'index1']); //done
