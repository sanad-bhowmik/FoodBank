...
class SettingResource extends JsonResource
{
    public function toArray($request)
    {
      return [
           ...
           'customer_app_logo'             => asset("images/" . setting('customer_app_logo')),
           'customer_splash_screen_logo'   => asset("images/" . setting('customer_splash_screen_logo')),
           'vendor_app_name'             => $this['vendor_app_name'],
           'vendor_app_logo'             => asset("images/" . setting('vendor_app_logo')),
           'vendor_splash_screen_logo'   => asset("images/" . setting('vendor_splash_screen_logo')),
           'delivery_app_name'             => $this['delivery_app_name'],
           'delivery_app_logo'             => asset("images/" . setting('delivery_app_logo')),
           'delivery_splash_screen_logo'   => asset("images/" . setting('delivery_splash_screen_logo')),
       ];
    }
}
